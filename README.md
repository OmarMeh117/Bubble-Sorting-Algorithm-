# Please take note that the bubble sort algorithm that I have created can only use high numbers like 1000 or so, otherwise anything else will give you a time of 0.00.
